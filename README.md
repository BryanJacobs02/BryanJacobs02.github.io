...
<div style="text-align: center;">
  <a href="[https://your-link.com](https://github.com/BryanJacobs02/info523-final-project)">
    <img src="assets/img/info_523_project_image.png" alt="Project Image" style="width: 100%; max-width: 750px; border: 1px solid #ccc; border-radius: 10px; background-color: #f9f9f9; padding: 10px;" />
  </a>
</div>
